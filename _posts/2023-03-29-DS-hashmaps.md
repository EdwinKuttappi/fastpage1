...
<span class="c1"># prints out each unique number only once</span>
<span class="c1"># does not print out the extra 2 or 1</span>
...
<span class="c1"># it involves storing data using some data structure (dictionary, list, etc.)</span>
<span class="c1"># Hashmaps/hashtables are also another kind of data structure</span>
</pre></div>
...
<span class="c1"># dictionary for tracks</span>
<span class="c1"># list for the genre</span>
...
<span class="c1"># remove the extra taylor swift</span>
<span class="c1"># make the list into a set using the set function</span>
...
<span class="c1"># you can use the .append to add to the dictionary</span>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="k">for</span> <span class="n">k</span><span class="p">,</span><span class="n">v</span> <span class="ow">in</span> <span class="n">lover_album</span><span class="p">[</span><span class="s2">&quot;tracks&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">items</span><span class="p">():</span> <span class="c1"># iterate using a for loop for key and value</span>
...
<span class="c1"># add the [&quot;tracks&quot;]</span>
<span class="c1"># this will only print each number and then the song</span>
</pre></div>
...
<span class="c1"># allow the user to try inputting something again after inputting something invalid</span>
</pre></div>
...
<li>[x] Answer <em>ALL</em> questions in the code segments</li>
<li>Create a diagram or comparison illustration (Canva).<ul>
<li>[x] What are the pro and cons of using this data structure? </li>
<li>[x] Dictionary vs List    </li>
</ul>
</li>
<li>Expand upon the code given to you, possible improvements in comments</li>
<li><p>[x] Build your own album showing features of a python dictionary</p>
</li>
...
<div class="cell border-box-sizing text_cell rendered"><div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<p><div style="position: relative; width: 100%; height: 0; padding-top: 133.3333%;
...
<a href="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAFfLN1inuo&#x2F;view?utm_content=DAFfLN1inuo&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link" target="_blank" rel="noopener">HASHMAPS</a> by Edwin Abraham</p>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">album2</span> <span class="o">=</span> <span class="p">{</span>
    <span class="s2">&quot;title&quot;</span><span class="p">:</span> <span class="s2">&quot;Song Mix&quot;</span><span class="p">,</span>
    <span class="s2">&quot;artist&quot;</span><span class="p">:</span> <span class="s2">&quot;Yesudas&quot;</span><span class="p">,</span>
    <span class="s2">&quot;year&quot;</span><span class="p">:</span> <span class="mi">2010</span><span class="p">,</span>
    <span class="s2">&quot;genre&quot;</span><span class="p">:</span> <span class="p">[</span><span class="s2">&quot;Folk&quot;</span><span class="p">,</span> <span class="s2">&quot;Alternative&quot;</span><span class="p">],</span>
    <span class="s2">&quot;tracks&quot;</span><span class="p">:</span> <span class="p">{</span>
        <span class="mi">1</span><span class="p">:</span> <span class="s2">&quot;Sing Song&quot;</span><span class="p">,</span>
        <span class="mi">2</span><span class="p">:</span> <span class="s2">&quot;Kala&quot;</span><span class="p">,</span>
        <span class="mi">3</span><span class="p">:</span> <span class="s2">&quot;Kolaveri&quot;</span><span class="p">,</span>
        <span class="mi">4</span><span class="p">:</span> <span class="s2">&quot;Mandaraame&quot;</span><span class="p">,</span>
        <span class="mi">5</span><span class="p">:</span> <span class="s2">&quot;Bangalore Days&quot;</span><span class="p">,</span>
        <span class="mi">6</span><span class="p">:</span> <span class="s2">&quot;Banke&quot;</span><span class="p">,</span>
        <span class="mi">7</span><span class="p">:</span> <span class="s2">&quot;Muqabla&quot;</span><span class="p">,</span>
        <span class="mi">8</span><span class="p">:</span> <span class="s2">&quot;Naatu&quot;</span><span class="p">,</span>
        <span class="mi">9</span><span class="p">:</span> <span class="s2">&quot;ABC 123&quot;</span><span class="p">,</span>
        <span class="mi">10</span><span class="p">:</span> <span class="s2">&quot;Karthave&quot;</span><span class="p">,</span>
        <span class="mi">11</span><span class="p">:</span> <span class="s2">&quot;Rajave&quot;</span>
    <span class="p">}</span>
<span class="p">}</span>

<span class="nb">print</span><span class="p">(</span><span class="n">album2</span><span class="p">)</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>{&#39;title&#39;: &#39;Song Mix&#39;, &#39;artist&#39;: &#39;Yesudas&#39;, &#39;year&#39;: 2010, &#39;genre&#39;: [&#39;Folk&#39;, &#39;Alternative&#39;], &#39;tracks&#39;: {1: &#39;Sing Song&#39;, 2: &#39;Kala&#39;, 3: &#39;Kolaveri&#39;, 4: &#39;Mandaraame&#39;, 5: &#39;Bangalore Days&#39;, 6: &#39;Banke&#39;, 7: &#39;Muqabla&#39;, 8: &#39;Naatu&#39;, 9: &#39;ABC 123&#39;, 10: &#39;Karthave&#39;, 11: &#39;Rajave&#39;}}
</pre>
</div>
</div>
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">album2</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="s1">&#39;tracks&#39;</span><span class="p">))</span>
<span class="c1"># or</span>
<span class="nb">print</span><span class="p">(</span><span class="n">album2</span><span class="p">[</span><span class="s1">&#39;tracks&#39;</span><span class="p">])</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>{1: &#39;Sing Song&#39;, 2: &#39;Kala&#39;, 3: &#39;Kolaveri&#39;, 4: &#39;Mandaraame&#39;, 5: &#39;Bangalore Days&#39;, 6: &#39;Banke&#39;, 7: &#39;Muqabla&#39;, 8: &#39;Naatu&#39;, 9: &#39;ABC 123&#39;, 10: &#39;Karthave&#39;, 11: &#39;Rajave&#39;}
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="n">album2</span><span class="p">[</span><span class="s2">&quot;tracks&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">update</span><span class="p">({</span><span class="mi">11</span><span class="p">:</span> <span class="s2">&quot;Mama Rajave&quot;</span><span class="p">})</span>

<span class="n">album2</span><span class="p">[</span><span class="s2">&quot;genre&quot;</span><span class="p">]</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="s2">&quot;Anna Pesaha&quot;</span><span class="p">)</span>
</pre></div>
